...
Write import re at the top of your script and use the re.findall() function
to write a regex that matches the following, and prints the matches to the
user (you). Use pythex.org if you'd like to text regexes (but make sure to
run each regex in pythonanywhere or on your own machine):"""
